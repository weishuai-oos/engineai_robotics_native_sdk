...
const mjuiDef defFile[] = {
    {mjITEM_SECTION, "File", mjPRESERVE, nullptr, "AF"}, {mjITEM_BUTTON, "Save xml", 2, nullptr, ""},
...
void MakePhysicsSection(mj::Simulate* sim) {
  ...
  mjuiDef defOverride[] = {
      {mjITEM_SEPARATOR, "Contact Override", mjPRESERVE},       {mjITEM_EDITNUM, "Margin", 2, &(opt->o_margin), "1"},
...
void MakeControlSection(mj::Simulate* sim) {
  mjuiDef defControl[] = {
      {mjITEM_SECTION, "Control", mjPRESERVE, nullptr, "AC"}, {mjITEM_BUTTON, "Clear all", 2}, {mjITEM_END}};
  mjuiDef defSlider[] = {{mjITEM_SLIDERNUM, "", 2, nullptr, "0 1"}, {mjITEM_END}};
